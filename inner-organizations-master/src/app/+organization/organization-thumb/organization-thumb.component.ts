...
@Component({
    selector: 'organization-thumb',
    templateUrl: './organization-thumb.component.html',
    styleUrls: ['./organization-thumb.component.scss'],
})
export class OrganizationThumbComponent extends OrganizationComponent {
    @Input()
    ...
    ngOnInit() {
        this.appState.prevButtonEvent.subscribe(() => {
            ...
            console.log('OrganizationThumbComponent showPrevButton: ', this.showPrevButton);
        });
    }
